#!/bin/bash
#SBATCH --job-name="Eval_nactlat_fm_robocasa_100demos_baseline"
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --comment="Eval_nactlat_fm_robocasa_100demos_baseline"
...
PORT=$(( 27800 + (SLURM_ARRAY_TASK_ID * 100) + (RANDOM % 100) ))
