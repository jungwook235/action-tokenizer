#!/bin/bash
#SBATCH --job-name="Eval_actlat_fm_robocasa_100demos_v2_hand_pred_norecon_mask_fullstate"
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --comment="Eval_actlat_fm_robocasa_100demos_v2_hand_pred_norecon_mask_fullstate"
...
CKPT_NAME="vla_actlat_fm_robocasa_100demos/v2_hand_pred_norecon_mask_fullstate"
