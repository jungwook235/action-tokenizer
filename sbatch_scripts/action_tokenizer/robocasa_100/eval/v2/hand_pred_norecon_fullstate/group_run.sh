...
SBATCH_FILE="/sjw_alinlab1/home/jungwook/Isaac-GR00T/sbatch_scripts/action_tokenizer/robocasa_100/eval/v2/hand_pred_norecon_fullstate/eval_robocasa_local.sh"
