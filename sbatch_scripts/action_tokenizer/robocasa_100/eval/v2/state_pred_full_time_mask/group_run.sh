...
SBATCH_FILE="/sjw_alinlab1/home/jungwook/Isaac-GR00T/sbatch_scripts/action_tokenizer/robocasa_100/eval/v2/state_pred_full_time_mask/eval_robocasa_local.sh"
