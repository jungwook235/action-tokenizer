#!/bin/bash
#SBATCH --job-name=nactlat_fm_robotwin_23_baseline_fs_sbatch
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-nactlat_fm_robotwin_23_baseline_fs_sbatch.out
#SBATCH --error=out/%j-nactlat_fm_robotwin_23_baseline_fs_sbatch.err
#SBATCH --comment "nactlat_fm_robotwin_23_baseline_fs_sbatch"
...
CKPT_DIR="checkpoints/vla_nactlat_fm_robotwin_23/baseline_fs"
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "nactlat_baseline_fs_robotwin_23" \
    --mode "vla" \
    --num-gpus 2 \
    --batch-size 32 \
    --max-steps 60000 \
