#!/bin/bash
#SBATCH --job-name=gr00t_v2_headfix_state_pred_full_time_gr1_fs
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=sjw_alinlab,h100
#SBATCH --output=out/%j-gr00t_v2_headfix_state_pred_full_time_gr1_fs.out
#SBATCH --error=out/%j-gr00t_v2_headfix_state_pred_full_time_gr1_fs.err
#SBATCH --comment "gr00t_v2_headfix_state_pred_full_time_gr1_fs"
...
VLA_CKPT_DIR=checkpoints/vla_actlat_fm_gr1_100demos/v2_headfix_state_pred_full_time_fs
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_v2_headfix_state_pred_full_time_gr1_100demos_fs" \
    --num-gpus 2 \
    --batch-size 32 \
    --max-steps 60000 \
    --save-steps 10000 \
