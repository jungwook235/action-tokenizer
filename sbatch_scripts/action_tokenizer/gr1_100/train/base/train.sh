#!/bin/bash
#SBATCH --job-name=action_tokenizer_gr1_100demos_base_sbatch
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-action_tokenizer_gr1_100demos_base_sbatch.out
#SBATCH --error=out/%j-action_tokenizer_gr1_100demos_base_sbatch.err
#SBATCH --comment "action_tokenizer_gr1_100demos_base_sbatch"
