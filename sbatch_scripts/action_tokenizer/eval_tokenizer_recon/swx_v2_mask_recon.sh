...
# Match training: swx_100/full_train/v2/mask_recon.sh
# (training script names the checkpoint dir swx_100demos_v2_maskloss).
...
OUT_DIR=experiments/runs/recon_eval/swx_v2_mask_recon
