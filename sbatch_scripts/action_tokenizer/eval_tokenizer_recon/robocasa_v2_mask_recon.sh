...
# Match training: robocasa_100/full_train/v2/mask_recon.sh
# (training script names the checkpoint dir robocasa_100demos_v2_maskloss).
...
OUT_DIR=experiments/runs/recon_eval/robocasa_v2_mask_recon
