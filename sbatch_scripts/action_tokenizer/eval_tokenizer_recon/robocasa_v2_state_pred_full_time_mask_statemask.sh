...
# Match training: robocasa_100/full_train/v2/state_pred_full_time_mask_statemask.sh
...
OUT_DIR=experiments/runs/recon_eval/robocasa_v2_state_pred_full_time_mask_statemask
