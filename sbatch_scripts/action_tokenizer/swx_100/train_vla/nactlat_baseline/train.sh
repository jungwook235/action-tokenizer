#!/bin/bash
#SBATCH --job-name=nactlat_fm_swx_100demos_baseline_sbatch
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-nactlat_fm_swx_100demos_baseline_sbatch.out
#SBATCH --error=out/%j-nactlat_fm_swx_100demos_baseline_sbatch.err
#SBATCH --comment "nactlat_fm_swx_100demos_baseline_sbatch"
...
CKPT_DIR="checkpoints/vla_nactlat_fm_swx_100demos/baseline"
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "nactlat_baseline_swx_100demos" \
    --mode "vla" \
    --num-gpus 2 \
    --batch-size 32 \
    --max-steps 60000 \
