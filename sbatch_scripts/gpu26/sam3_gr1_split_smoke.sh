...
#
# a100 + background QoS only (wook's guaranteed partition is h200); the %8 throttle
# matches the 8-GPU background budget.
...
OUT_ROOT=/ckpt/$USER/gr1_sam3_split_smoke          # jobs use, so an existing extraction
