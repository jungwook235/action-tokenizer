#!/bin/bash
#SBATCH --job-name="Eval_actlat_fm_robocasa_100demos_v2_maskloss"
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --comment="Eval_actlat_fm_robocasa_100demos_v2_maskloss"
...
CKPT_NAME="vla_actlat_fm_robocasa_100demos/v2_maskloss"
