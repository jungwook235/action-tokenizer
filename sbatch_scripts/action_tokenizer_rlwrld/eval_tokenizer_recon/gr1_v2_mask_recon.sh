...
# Match training: gr1_100/full_train/v2/mask_recon.sh
# (gr1's mask_recon.sh trains the checkpoint dir gr1_100demos_v2_maskloss).
DATA_DIR=/storage1/sjw_dataset/dataset/robocasa_gr1_tabletop/sim_100demos
DATA_CONFIG=fourier_gr1_arms_waist
TOK_CKPT_DIR=checkpoints_action_tokenizer/gr1_100demos_v2_maskloss
TOK_STEP=100000
...
OUT_DIR=experiments/runs/recon_eval/gr1_v2_mask_recon
