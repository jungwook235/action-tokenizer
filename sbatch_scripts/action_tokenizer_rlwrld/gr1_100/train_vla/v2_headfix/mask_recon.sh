#!/bin/bash
#SBATCH --job-name=gr00t_v2_headfix_mask_recon_gr1
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=sjw_alinlab,h100
#SBATCH --output=out/%j-gr00t_v2_headfix_mask_recon_gr1.out
#SBATCH --error=out/%j-gr00t_v2_headfix_mask_recon_gr1.err
#SBATCH --comment "gr00t_v2_headfix_mask_recon_gr1"
...
VLA_CKPT_DIR=checkpoints/vla_actlat_fm_gr1_100demos/v2_headfix_mask_recon
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_v2_headfix_mask_recon_gr1_100demos" \
    --num-gpus 2 \
    --batch-size 32 \
    --max-steps 60000 \
    --save-steps 10000 \
