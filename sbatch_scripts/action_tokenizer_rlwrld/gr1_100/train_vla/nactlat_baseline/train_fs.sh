#!/bin/bash
#SBATCH --job-name=nactlat_fm_gr1_100demos_baseline_fs_sbatch
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-nactlat_fm_gr1_100demos_baseline_fs_sbatch.out
#SBATCH --error=out/%j-nactlat_fm_gr1_100demos_baseline_fs_sbatch.err
#SBATCH --comment "nactlat_fm_gr1_100demos_baseline_fs_sbatch"
...
CKPT_DIR="checkpoints/vla_nactlat_fm_gr1_100demos/baseline_fs"
