#!/bin/bash
#SBATCH --job-name=actlat_fm_gr1_100demos_base_sbatch_fs
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=sjw_alinlab,h100
#SBATCH --output=out/%j-actlat_fm_gr1_100demos_base_sbatch_fs.out
#SBATCH --error=out/%j-actlat_fm_gr1_100demos_base_sbatch_fs.err
#SBATCH --comment "actlat_fm_gr1_100demos_base_sbatch_fs"
...
CKPT_DIR="checkpoints/vla_actlat_fm_gr1_100demos/base_fs"
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_base_gr1_100demos_fs" \
    --num-gpus 2 \
    --batch-size 32 \
    --max-steps 60000 \
    --save-steps 10000 \
