#!/bin/bash
#SBATCH --job-name=actlat_v2_full_sbatch
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-actlat_v2_full_sbatch.out
#SBATCH --error=out/%j-actlat_v2_full_sbatch.err
#SBATCH --comment "actlat_v2_full_sbatch"
