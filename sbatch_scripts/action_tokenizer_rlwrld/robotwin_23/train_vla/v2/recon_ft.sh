#!/bin/bash
#SBATCH --job-name=gr00t_robotwin_23_full_v2_recon_ft
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-gr00t_robotwin_23_full_v2_recon_ft.out
#SBATCH --error=out/%j-gr00t_robotwin_23_full_v2_recon_ft.err
#SBATCH --comment "gr00t_robotwin_23_full_v2_recon_ft"
...
VLA_CKPT_DIR=checkpoints/vla_actlat_fm_robotwin_23/v2_recon_ft
TOK_STEP=100000
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_v2_recon_ft_robotwin_23" \
    --num-gpus 2 \
    --batch-size 32 \
    --max-steps 60000 \
    --save-steps 10000 \
