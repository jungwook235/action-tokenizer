#!/bin/bash
#SBATCH --job-name=full_v4_gr1_recon_dino_bn64_l1_mse_naiveln_vae_1000tok_ft
...
#SBATCH --output=/NHNHOME/data/wook/action-tokenizer/slurm/logs/full_v4_gr1_recon_dino_bn64_l1_mse_naiveln_vae_1000tok_ft_%j.out
#SBATCH --error=/NHNHOME/data/wook/action-tokenizer/slurm/logs/full_v4_gr1_recon_dino_bn64_l1_mse_naiveln_vae_1000tok_ft_%j.err
...
VLA_CKPT_DIR=checkpoints/vla_actlat_fm_gr1_100demos/v4_recon_dino_bn64_l1_mse_naiveln_vae_1000tok
TOK_STEP=100000
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_v4_gr1_recon_dino_bn64_l1_mse_naiveln_vae_100demos_1000tok" \
    --num-gpus 8 \
    --batch-size 8 \
    --max-steps 60000 \
    --save-steps 5000 \
