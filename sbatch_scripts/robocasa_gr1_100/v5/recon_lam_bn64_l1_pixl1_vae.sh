#!/bin/bash
#SBATCH --job-name=full_v5_gr1_recon_lam_bn64_l1_pixl1_vae_fs
#SBATCH --partition=gpu
#SBATCH --gres=gpu:b200:4
#SBATCH --nodes=1
#SBATCH --time=72:00:00
#SBATCH --output=/NHNHOME/data/wook/action-tokenizer/slurm/logs/full_v5_gr1_recon_lam_bn64_l1_pixl1_vae_fs_%j.out
#SBATCH --error=/NHNHOME/data/wook/action-tokenizer/slurm/logs/full_v5_gr1_recon_lam_bn64_l1_pixl1_vae_fs_%j.err
...
python scripts/train_action_latent_tokenizer_v5.py \
    ...
    --run-name "actlat_v5_gr1_recon_lam_bn64_l1_pixl1_vae_100demos" \
    --num-gpus 4 \
    --batch-size 64 \
    --max-steps $TOK_STEP \
    --save-steps 10000 \
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_v5_gr1_recon_lam_bn64_l1_pixl1_vae_fs_100demos" \
    --num-gpus 4 \
    --batch-size 16 \
    --max-steps 60000 \
    --save-steps 5000 \
