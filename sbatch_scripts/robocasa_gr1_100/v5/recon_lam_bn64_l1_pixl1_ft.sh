#!/bin/bash
#SBATCH --job-name=full_v5_gr1_recon_lam_bn64_l1_pixl1_ft
#SBATCH --partition=gpu
#SBATCH --gres=gpu:b200:4
#SBATCH --nodes=1
#SBATCH --time=72:00:00
#SBATCH --output=/NHNHOME/data/wook/action-tokenizer/slurm/logs/full_v5_gr1_recon_lam_bn64_l1_pixl1_ft_%j.out
#SBATCH --error=/NHNHOME/data/wook/action-tokenizer/slurm/logs/full_v5_gr1_recon_lam_bn64_l1_pixl1_ft_%j.err
...
VLA_CKPT_DIR=checkpoints/vla_actlat_fm_gr1_100demos/v5_recon_lam_bn64_l1_pixl1_ft
TOK_STEP=100000
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_v5_gr1_recon_lam_bn64_l1_pixl1_ft_100demos" \
    --num-gpus 4 \
    --batch-size 16 \
    --max-steps 60000 \
    --save-steps 5000 \
