#!/bin/bash
#SBATCH --job-name=full_v4_dexjoco_single_arm_recon_dino_bn64_l1_mse_naiveln_vae_fs
...
#SBATCH --output=/NHNHOME/data/wook/action-tokenizer/slurm/logs_dexjoco/full_v4_dexjoco_single_arm_recon_dino_bn64_l1_mse_naiveln_vae_fs_%j.out
#SBATCH --error=/NHNHOME/data/wook/action-tokenizer/slurm/logs_dexjoco/full_v4_dexjoco_single_arm_recon_dino_bn64_l1_mse_naiveln_vae_fs_%j.err
...
VLA_CKPT_DIR=checkpoints/vla_actlat_fm_dexjoco_single_arm/v4_recon_dino_bn64_l1_mse_naiveln_vae_fs
TOK_STEP=100000
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_v4_dexjoco_single_arm_recon_dino_bn64_l1_mse_naiveln_vae_fs" \
    --num-gpus 4 \
    --batch-size 16 \
    --max-steps 60000 \
    --save-steps 5000 \
