#!/bin/bash
#SBATCH --job-name=full_v4_dexjoco_dual_arm_recon_dino_bn64_l1_mse_naiveln_vae_4gpu
...
#SBATCH --output=/NHNHOME/data/wook/action-tokenizer/slurm/logs_dexjoco/full_v4_dexjoco_dual_arm_recon_dino_bn64_l1_mse_naiveln_vae_4gpu_%j.out
#SBATCH --error=/NHNHOME/data/wook/action-tokenizer/slurm/logs_dexjoco/full_v4_dexjoco_dual_arm_recon_dino_bn64_l1_mse_naiveln_vae_4gpu_%j.err
...
TOK_CKPT_DIR=checkpoints_action_tokenizer/dexjoco_dual_arm_v4_recon_dino_bn64_l1_mse_naiveln_vae_4gpu
VLA_CKPT_DIR=checkpoints/vla_actlat_fm_dexjoco_dual_arm/v4_recon_dino_bn64_l1_mse_naiveln_vae_4gpu
TOK_STEP=100000
...
python scripts/train_action_latent_tokenizer_v4.py \
    ...
    --run-name "actlat_v4_dexjoco_dual_arm_recon_dino_bn64_l1_mse_naiveln_vae_4gpu" \
    --num-gpus 4 \
    --batch-size 128 \
    --max-steps $TOK_STEP \
    --save-steps 10000 \
