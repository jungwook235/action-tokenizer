#!/bin/bash
#SBATCH --job-name=nactlat_fm_dexjoco_dual_arm_base_sbatch
...
#SBATCH --output=/NHNHOME/data/wook/action-tokenizer/slurm/logs_1000/nactlat_fm_dexjoco_dual_arm_base_sbatch_%j.out
#SBATCH --error=/NHNHOME/data/wook/action-tokenizer/slurm/logs_1000/nactlat_fm_dexjoco_dual_arm_base_sbatch_%j.err
