#!/bin/bash
#SBATCH --job-name=full_v3_gr1_recon_ln_bn16
...
#SBATCH --output=/NHNHOME/data/wook/action-tokenizer/slurm/logs_1000/full_v3_gr1_recon_ln_bn16_%j.out
#SBATCH --error=/NHNHOME/data/wook/action-tokenizer/slurm/logs_1000/full_v3_gr1_recon_ln_bn16_%j.err
...
VLA_CKPT_DIR=checkpoints/vla_actlat_fm_gr1_1000demos/v3_recon_ln_bn16
TOK_STEP=100000
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_v3_gr1_recon_ln_bn16_1000demos" \
    --num-gpus 8 \
    --batch-size 64 \
    --max-steps 60000 \
    --save-steps 5000 \
