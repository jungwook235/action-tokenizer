#!/bin/bash
#SBATCH --job-name=full_v3_gr1_recon_ln_bn16_256bs
...
#SBATCH --output=/NHNHOME/data/wook/action-tokenizer/slurm/logs_1000/full_v3_gr1_recon_ln_bn16_256bs_%j.out
#SBATCH --error=/NHNHOME/data/wook/action-tokenizer/slurm/logs_1000/full_v3_gr1_recon_ln_bn16_256bs_%j.err
...
TOK_CKPT_DIR=checkpoints_action_tokenizer/gr1_1000demos_v3_recon_ln_bn16
VLA_CKPT_DIR=checkpoints/vla_actlat_fm_gr1_1000demos/v3_recon_ln_bn16_256bs
TOK_STEP=100000
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_v3_gr1_recon_ln_bn16_256bs_1000demos" \
    --num-gpus 4 \
    --batch-size 64 \
    --max-steps 60000 \
    --save-steps 5000 \
