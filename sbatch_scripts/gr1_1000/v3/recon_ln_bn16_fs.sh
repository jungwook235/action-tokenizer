#!/bin/bash
#SBATCH --job-name=full_v3_gr1_recon_ln_bn16_fs
#SBATCH --partition=gpu
#SBATCH --gres=gpu:b200:4
#SBATCH --nodes=1
#SBATCH --time=72:00:00
#SBATCH --output=/NHNHOME/data/wook/action-tokenizer/slurm/logs/full_v3_gr1_recon_ln_bn16_fs%j.out
#SBATCH --error=/NHNHOME/data/wook/action-tokenizer/slurm/logs/full_v3_gr1_recon_ln_bn16_fs%j.err
...
VLA_CKPT_DIR=checkpoints/vla_actlat_fm_gr1_1000demos/v3_recon_ln_bn16_fs
TOK_STEP=100000
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_v3_gr1_recon_ln_bn16_fs_1000demos" \
    --num-gpus 4 \
    --batch-size 128 \
    --max-steps 60000 \
    --save-steps 5000 \
