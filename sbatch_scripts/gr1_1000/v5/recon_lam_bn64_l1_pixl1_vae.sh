#!/bin/bash
#SBATCH --job-name=full_v5_gr1_recon_lam_bn64_l1_pixl1_vae
#SBATCH --partition=gpu
#SBATCH --gres=gpu:b200:4
#SBATCH --nodes=1
#SBATCH --time=72:00:00
#SBATCH --output=/NHNHOME/data/wook/action-tokenizer/slurm/logs_1000/full_v5_gr1_recon_lam_bn64_l1_pixl1_vae_%j.out
#SBATCH --error=/NHNHOME/data/wook/action-tokenizer/slurm/logs_1000/full_v5_gr1_recon_lam_bn64_l1_pixl1_vae_%j.err
...
#    --run-name "actlat_v5_gr1_recon_lam_bn64_l1_pixl1_vae_1000demos" \
#    --num-gpus 4 \
#    --batch-size 64 \
#    --max-steps $TOK_STEP \
#    --save-steps 10000 \
...
python scripts/gr00t_finetune_actlat_fm.py \
    ...
    --run-name "actlat_fm_v5_gr1_recon_lam_bn64_l1_pixl1_vae_1000demos" \
    --num-gpus 4 \
    --batch-size 64 \
    --max-steps 60000 \
    --save-steps 5000 \
